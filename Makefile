...
KIND_CLUSTER ?= hivemind-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name hivemind-builder
	$(CONTAINER_TOOL) buildx use hivemind-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm hivemind-builder
	rm Dockerfile.cross
